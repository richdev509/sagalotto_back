        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="forms-sample"
                    @if (isset($record)) action="/wp-admin/HttpAddlo"  @else action="/wp-admin/HttpAddlo" @endif
                    ...
                    <div class="form-group" style="margin-bottom: 10px;">
                        ...
                        <select name="tirageid" class="form-control" id="select" placeholder="List tiraj"
                            style="height: 49px;
                    border-color: #e95d14;

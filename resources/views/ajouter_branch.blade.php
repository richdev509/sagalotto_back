      ...
      <style>
            ...
            .percent-input-box {
              ...
              <div class="page-header">
                <h3 class="page-title">Fòm Ajoute Branch</h3>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9 icon-input">
                                ...
                                <input type="text" name="name" value="{{old('name')}}" class="form-control" placeholder="Ba li yon non" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9 icon-input">
                                    ...
                                    <input type="text" class="form-control" value="{{old('phone')}}"  placeholder="Nimewo telefòn" name="phone" />
                              ...
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9 icon-input">
                                    ...
                                    <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3" placeholder="Ekri yon ti deskripsyon..."></textarea>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9 icon-input">
                                ...
                                <input type="text" name="agent_name" value="{{old('agent_name')}}" class="form-control" placeholder="Tout non sipèvizè a" />
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9 icon-input">
                                ...
                                <input type="text" class="form-control" name="agent_username" vlaue="{{old('agent_username')}}" placeholder="Itilizatè pou konekte"/>
                          ...
                          <div class="col-md-6">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9 icon-input">
                                ...
                                <input type="password" name="agent_password" value="{{old('agent_password')}}" class="form-control" placeholder="Chwazi yon modpas solid"/>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="radio-card" onclick="selectRadio('percent_both')">
                                <input class="form-check-input" type="radio" name="percentage_type" id="percent_both" value="both" checked>
                              ...
                              <div class="radio-card" onclick="selectRadio('percent_agent_only')">
                                <input class="form-check-input" type="radio" name="percentage_type" id="percent_agent_only" value="agent_only">
                            ...
                            <div class="form-group">
                              ...
                              <div class="percent-input-box">
                                <div class="icon-input">
                                  <i class="mdi mdi-percent"></i>
                                  <input type="number" id="percent_value" name="percent_agent_only" class="form-control" placeholder="Antre pousantaj pou sipèvizè" min="0" max="100" step="0.01" value="0"/>
                                </div>
                                ...
                                <span class="error">@error('percent_agent_only') 
                                  {{$message}}
                                 @enderror</span>
                              </div>
                            </div>

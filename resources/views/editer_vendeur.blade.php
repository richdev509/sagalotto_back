                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" name="name" value="{{ $vendeur->name }}"
                                            class="form-control" placeholder="non konplè" />
                                        <span class="error">
                                            @error('name')
                                                {{ $message }}
                                            @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="address" value="{{ $vendeur->address }}"
                                            class="form-control" placeholder="adrès vandè a" />
                                        <span class="error">
                                            @error('address')
                                                {{ $message }}
                                            @enderror
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="{{ $vendeur->phone }}"
                                            placeholder="Telefon vandè a" name="phone" />
                                        <span class="error">
                                            @error('phone')
                                                {{ $message }}
                                            @enderror
                        ...
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" value="{{ $vendeur->percent }}"
                                            placeholder="pousantaj" name="percent" />
                                        <span class="error">
                                            @error('percent')
                                                {{ $message }}
                                            @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" style="height: 45px;" name="branch"
                                            value="{{ old('branch') }}">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox"
                                                    @if ($vendeur->is_block == '1') @checked(true) @endif
                                                    class="form-check-inpu" name="block" value="1"
                                                    id="membershipRadios2"> Bloke </label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bank_name" value="{{ $vendeur->bank_name }}"
                                            class="form-control" placeholder="Egzanp: bank1" />
                                        <span class="error">
                                            @error('bank_name')
                                                {{ $message }}
                                            @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="username" value="{{ $vendeur->username }}"
